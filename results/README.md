...
* Generated by ./scripts/05-UKBB_SRDiseases.R
* Disease hierarchy for the self-reported diseases in UK Biobank.

## UKBB_disease_EDA/nCase_dist

* Generated by ./scripts/05-UKBB_SRDiseases.R
* The number of cases per disease. The x-axis is on log 10 scale. 129 diseases have more than 2,000 diseases.
