...
signifGenes <- sapply(names(eqtlGenes),function(nm){
  unique(c(proxyGenes[[nm]],eqtlGenes[[nm]]))
})
names(signifGenes) = names(eqtlGenes)
...
ggsave('./results/genomicAnalysis/numberGenes.pdf',p_numbergenes,units = 'cm',width = 18,height = 14,useDingbats = F)
ggsave('./results/genomicAnalysis/numberGenes.png',p_numbergenes,units = 'cm',width = 18,height = 14)

ggsave('./results/genomicAnalysis/numGene_perDisease.pdf', numSignif_perDisease, units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/numGene_perDisease.png', numSignif_perDisease, units = 'cm', width = 8, height = 7)

ggsave('./results/genomicAnalysis/numGene_perDisease_byAgeOnset.pdf', numSignif_by_ageonset, units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/numGene_perDisease_byAgeOnset.png', numSignif_by_ageonset, units = 'cm', width = 8, height = 7)

ggsave('./results/genomicAnalysis/numGene_perDisease_byCategory.pdf', numSignif_by_cat, units = 'cm', width = 16, height = 8, useDingbats = F)
ggsave('./results/genomicAnalysis/numGene_perDisease_byCategory.png', numSignif_by_cat, units = 'cm', width = 16, height = 8)
...
ggsave('./results/genomicAnalysis/diseaseperGene.pdf',dispergene,units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/diseaseperGene.png',dispergene,units = 'cm', width = 8, height = 7)
...
ggsave('./results/genomicAnalysis/categoryperGene.pdf',catpergene,units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/categoryperGene.png',catpergene,units = 'cm', width = 8, height = 7)


pergeneplots = ggarrange(dispergene,catpergene,labels = c('a','b'),align = 'hv')
ggsave('./results/genomicAnalysis/perGene.pdf',pergeneplots,units = 'cm', width = 16, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/perGene.png',pergeneplots,units = 'cm', width = 16, height = 7)
...
totGeneNum = length(union(totgenes,totgenes_eqtl))
...
saveRDS(odds,'./data/processed/genomicAnalysis/diseaseSim_odds_basedonGenes.rds')
diag(odds) = NA
...
saveRDS(p,'./data/processed/genomicAnalysis/diseaseSim_p_basedonGenes.rds')
odds[p>0.01] = 1
l2odds = log2(odds)
i = which(rowMeans(l2odds==0, na.rm =T) != 1)
l2odds = l2odds[i,i]
rownames(disannot) = disannot$disease
pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifGeneoverlap_heatmap.pdf')

pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifGeneoverlap_heatmap.png')

l2odds = log2(odds)
# i = which(rowMeans(l2odds==0, na.rm =T) != 1)
# l2odds = l2odds[i,i]
rownames(disannot) = disannot$disease
pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifGeneoverlap_heatmap_all.pdf')

pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifGeneoverlap_heatmap_all.png')
...
netp
ggsave('./results/genomicAnalysis/GENEnet.pdf', netp, units = 'cm', width = 18, height = 8, useDingbats = F)
ggsave('./results/genomicAnalysis/GENEnet.png', netp, units = 'cm', width = 18, height = 8)
