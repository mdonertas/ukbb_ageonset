...
signifGenes <- sapply(paste('./data/processed/caseControl/a',disIDs,'/signif_gwasRes_proxyGenes.rds',sep=''),function(x){
  x=readRDS(x)
...
ggsave('./results/genomicAnalysis/numberProxyGenes.pdf',p_numbergenes,units = 'cm',width = 18,height = 14,useDingbats = F)
ggsave('./results/genomicAnalysis/numberProxyGenes.png',p_numbergenes,units = 'cm',width = 18,height = 14)

ggsave('./results/genomicAnalysis/numProxyGene_perDisease.pdf', numSignif_perDisease, units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/numProxyGene_perDisease.png', numSignif_perDisease, units = 'cm', width = 8, height = 7)

ggsave('./results/genomicAnalysis/numProxyGene_perDisease_byAgeOnset.pdf', numSignif_by_ageonset, units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/numProxyGene_perDisease_byAgeOnset.png', numSignif_by_ageonset, units = 'cm', width = 8, height = 7)

ggsave('./results/genomicAnalysis/numProxyGene_perDisease_byCategory.pdf', numSignif_by_cat, units = 'cm', width = 16, height = 8, useDingbats = F)
ggsave('./results/genomicAnalysis/numProxyGene_perDisease_byCategory.png', numSignif_by_cat, units = 'cm', width = 16, height = 8)
...
ggsave('./results/genomicAnalysis/diseaseperProxyGene.pdf',dispergene,units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/diseaseperProxyGene.png',dispergene,units = 'cm', width = 8, height = 7)
...
ggsave('./results/genomicAnalysis/categoryperProxyGene.pdf',catpergene,units = 'cm', width = 8, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/categoryperProxyGene.png',catpergene,units = 'cm', width = 8, height = 7)


pergeneplots = ggarrange(dispergene,catpergene,labels = c('a','b'),align = 'hv')
ggsave('./results/genomicAnalysis/perProxyGene.pdf',pergeneplots,units = 'cm', width = 16, height = 7, useDingbats = F)
ggsave('./results/genomicAnalysis/perProxyGene.png',pergeneplots,units = 'cm', width = 16, height = 7)

mean(cat_per_gene_l==1)
totgenes = readRDS('./data/processed/caseControl/a1071/gwasRes_proxyGenes.rds')
# totgenes_eqtl = readRDS('./data/processed/caseControl/a1071/gwasRes_eQTLGenes.rds')
totgenes = setdiff(unique(totgenes$proxy_hgnc),c('',NA))
# totgenes_eqtl = setdiff(unique(totgenes_eqtl$eQTL_hgnc),c('',NA))
...
saveRDS(odds,'./data/processed/genomicAnalysis/diseaseSim_odds_basedonProxyGenes.rds')
diag(odds) = NA
...
saveRDS(p,'./data/processed/genomicAnalysis/diseaseSim_p_basedonProxyGenes.rds')
odds[p>0.01] = 1
l2odds = log2(odds)
i = which(rowMeans(l2odds==0, na.rm =T) != 1)
l2odds = l2odds[i,i]
rownames(disannot) = disannot$disease
pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifProxyGeneoverlap_heatmap.pdf')

pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifProxyGeneoverlap_heatmap.png')

l2odds = log2(odds)
# i = which(rowMeans(l2odds==0, na.rm =T) != 1)
# l2odds = l2odds[i,i]
rownames(disannot) = disannot$disease
pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifProxyGeneoverlap_heatmap_all.pdf')

pheatmap::pheatmap(l2odds, color = colorRampPalette(brewer.pal(8,'Reds'))(20),cellwidth = 5, cellheight = 5, cutree_rows = 4, cutree_cols = 4, annotation_row = disannot[,-3], annotation_col = disannot[,-3], annotation_colors = annotcolors, fontsize = 6, filename = './results/genomicAnalysis/signifProxyGeneoverlap_heatmap_all.png')
...
netp
ggsave('./results/genomicAnalysis/ProxyGENEnet.pdf', netp, units = 'cm', width = 18, height = 8, useDingbats = F)
ggsave('./results/genomicAnalysis/ProxyGENEnet.png', netp, units = 'cm', width = 18, height = 8)
