...
ggsave('./results/UKBB_disease_EDA/nCases_sex.pdf', useDingbats=F, height=16, width = 10)
```
...
pheatmap::pheatmap(disAgeMat,cluster_cols = F, cellwidth=15,cellheight = 15,
                   breaks = seq(0,max(disAgeMat),length.out = 20),
                   color = colorRampPalette(RColorBrewer::brewer.pal(5,'Blues'))(19), filename='./results/UKBB_disease_EDA/ageOnsetHeatmap_10.pdf')
